...
export const ajaxGetAreaTreeItems = (code, params)=>getAction(`/park/parkArea/${code}`,params);
...
//考场查重
const checkRegionOnly = (params)=>getAction("/jkkc/region/queryByName",params);
